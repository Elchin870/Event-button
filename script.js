...
let aliyev = document.getElementById("Aliyev")
let zerif = document.getElementById("Zarif")
let moda = document.getElementById("Moda")

function filterByStoreName(value) {
    let filteredList = goods.filter((item) => item.store_name
        .toLowerCase()
...
aliyev.addEventListener("click", () => filterByStoreName("Əliyev Moda Mərkəzi"));

zerif.addEventListener("click", () => filterByStoreName("Zərif Moda"));

moda.addEventListener("click", () => filterByStoreName("Moda Dünyası"));
